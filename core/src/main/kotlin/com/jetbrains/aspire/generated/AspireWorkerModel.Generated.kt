...
class AspireWorkerModel private constructor(
    ...
    companion object : ISerializersOwner {
        ...
        override fun registerSerializersCore(serializers: ISerializers)  {
            ...
            serializers.register(LazyCompanionMarshaller(RdId(-7695483574898099182), classLoader, "com.jetbrains.aspire.generated.ResourceWrapper"))
            serializers.register(LazyCompanionMarshaller(RdId(-3770298982342277528), classLoader, "com.jetbrains.aspire.generated.ResourceModel"))
            serializers.register(LazyCompanionMarshaller(RdId(1247681944195290678), classLoader, "com.jetbrains.aspire.generated.ResourceProperty"))
            serializers.register(LazyCompanionMarshaller(RdId(-1423436662766610770), classLoader, "com.jetbrains.aspire.generated.ResourceEnvironmentVariable"))
            serializers.register(LazyCompanionMarshaller(RdId(552742225967993966), classLoader, "com.jetbrains.aspire.generated.ResourceUrl"))
            serializers.register(LazyCompanionMarshaller(RdId(-6198804010095377477), classLoader, "com.jetbrains.aspire.generated.ResourceVolume"))
            serializers.register(LazyCompanionMarshaller(RdId(2840668839301507407), classLoader, "com.jetbrains.aspire.generated.ResourceHealthStatus"))
            serializers.register(LazyCompanionMarshaller(RdId(2840668839259467409), classLoader, "com.jetbrains.aspire.generated.ResourceHealthReport"))
            serializers.register(LazyCompanionMarshaller(RdId(-7695483592723081526), classLoader, "com.jetbrains.aspire.generated.ResourceCommand"))
            serializers.register(LazyCompanionMarshaller(RdId(3095035063992014361), classLoader, "com.jetbrains.aspire.generated.ResourceRelationship"))
            serializers.register(LazyCompanionMarshaller(RdId(552742225967985219), classLoader, "com.jetbrains.aspire.generated.ResourceLog"))
            serializers.register(LazyCompanionMarshaller(RdId(-3460782994127365019), classLoader, "com.jetbrains.aspire.generated.ResourceCommandRequest"))
            ...
            serializers.register(LazyCompanionMarshaller(RdId(2722140349088377831), classLoader, "com.jetbrains.aspire.generated.ResourceCommandState"))
            serializers.register(LazyCompanionMarshaller(RdId(-8716242335550732449), classLoader, "com.jetbrains.aspire.generated.ResourceCommandResponseKind"))
        ...
        const val serializationHash = -6551212551227247950L
...
class AspireHostModel private constructor(
    ...
    companion object : IMarshaller<AspireHostModel> {
        ...
        override fun read(ctx: SerializationCtx, buffer: AbstractBuffer): AspireHostModel  {
            ...
            val _createSession = RdCall.read(ctx, buffer, AbstractPolymorphic(CreateSessionRequest), CreateSessionResponse)
...
/**
 * #### Generated from [AspireWorkerModel.kt:268]
 */
