...
/**
 * Fragmented editor for [AspireCliRunConfiguration].
 *
 * Reuses the platform's arguments / working-directory / environment fragments (the configuration implements
 * [com.intellij.execution.CommonProgramRunConfigurationParameters]) and adds Aspire-specific fields: the
 * required AppHost file, the optional Aspire CLI path and browser URL, and the "open browser" / "IDE
 * debugging" tags.
 */
