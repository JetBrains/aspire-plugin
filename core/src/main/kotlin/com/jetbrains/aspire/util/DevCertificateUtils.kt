...
suspend fun checkDevCertificate(project: Project, showNotification: Boolean = false): DevCertificateCheckResult {
    val diagnostics = collectDevCertificateDiagnostics(project)
...
private suspend fun collectDevCertificateDiagnostics(project: Project): DevCertificateDiagnostics {
