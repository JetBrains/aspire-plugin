...
class AspireMainServiceViewContributor : ServiceViewContributor<SessionHost>, ServiceViewLazyContributor {
    ...
    override fun getServices(project: Project) =
        SessionHostManager.getInstance(project).getSessionHosts()
