...
private val aspireKnownLogErrors = RiderKnownLogErrors + KnownLogErrors(
...
fun createAspireTestLogManager(
    traceScenarios: Set<LogTraceScenario>,
    traceCategories: List<String>,
): RiderTestLogManager {
    val traceSettings = TraceSettings(traceScenarios, traceCategories)

    return RiderTestLogManager(traceSettings, aspireKnownLogErrors)
}
